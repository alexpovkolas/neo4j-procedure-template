...
public class ASCIIFolding {
    ...
    @UserFunction
    @Description("apukls.asciiFolding(string) - converts alphabetic, numeric, and symbolic Unicode " +
            "characters which are not in the first 127 ASCII characters into their ASCII equivalents")
    public String asciiFolding(
            @Name("string") String string) {
        if (string == null) {
            return "";
        }
        return foldToASCII(string);
    }
    ...
    private String foldToASCII(String input, StringBuilder sb) {
